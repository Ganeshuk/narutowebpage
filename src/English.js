...
import Nav from "./Nav";
import "./Adult.css"; // Ensure this CSS file exists and is properly styled
...
function English() {
  ...
  useEffect(() => {
    // Fetch movies of type 'movie' from the new URL
    fetch('https://realworldback.onrender.com/movies/type/english', { method: 'GET' })
      .then((response) => {
        if (!response.ok) {
      ...
      .then((data) => {
        ...
        console.log(data, "Fetched movie data");
        setState(prevState => ({
          ...prevState,
